...
-- ----------------------------
-- Table structure for ega_study
-- ----------------------------
DROP TABLE IF EXISTS "bibliography"."ega_study";
CREATE TABLE "bibliography"."ega_study" (
  "ega_accession_id" varchar(50) COLLATE "pg_catalog"."default" NOT NULL
)
;

-- ----------------------------
-- Table structure for ega_study_article
-- ----------------------------
DROP TABLE IF EXISTS "bibliography"."ega_study_article";
CREATE TABLE "bibliography"."ega_study_article" (
  "ega_accession_id" varchar(50) COLLATE "pg_catalog"."default" NOT NULL,
  "article_id" int4 NOT NULL
)
;
...
-- ----------------------------
-- Primary Key structure for table ega_study
-- ----------------------------
ALTER TABLE "bibliography"."ega_study" ADD CONSTRAINT "ega_study_pkey" PRIMARY KEY ("ega_accession_id");

-- ----------------------------
-- Primary Key structure for table ega_study_article
-- ----------------------------
ALTER TABLE "bibliography"."ega_study_article" ADD CONSTRAINT "ega_study_article_pkey" PRIMARY KEY ("ega_accession_id", "article_id");
...
-- ----------------------------
-- Foreign Keys structure for table ega_study_article
-- ----------------------------
ALTER TABLE "bibliography"."ega_study_article" ADD CONSTRAINT "ega_study_article_article_id_fkey" FOREIGN KEY ("article_id") REFERENCES "bibliography"."article" ("article_id") ON DELETE NO ACTION ON UPDATE NO ACTION;
ALTER TABLE "bibliography"."ega_study_article" ADD CONSTRAINT "ega_study_article_ega_accession_id_fkey" FOREIGN KEY ("ega_accession_id") REFERENCES "bibliography"."ega_study" ("ega_accession_id") ON DELETE NO ACTION ON UPDATE NO ACTION;
